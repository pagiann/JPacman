...
import static jpacman.controller.edumode.AIAlgorithmsStepwiseLearningController.*;
...
public class AIAlgorithmsStepwiseLearningRenderer extends AIAlgorithmsLearningRenderer
{
    ...
    public static final Text executeAlgorithmText = new Text(" Execute\nalgorithm", Text.DEFAULT_FONT_MEDIUM, Screen.WHITE_COLOR);
    public static final UIButton startResumeExecuteAlgorithmButton = new UIButton(new Point(GameApplication.X_OFFSET + Maze.WIDTH + 95, GameApplication.Y_OFFSET + 5), false, startText, true);
    ...
    public static final UIButton executionMode = new UIButton(new Point(GameApplication.X_OFFSET + Maze.WIDTH + 200, GameApplication.Y_OFFSET + 57), false, manualModeText, true);
    ...
    public static final UIButton minStepSize = new UIButton(new Point(GameApplication.X_OFFSET + Maze.WIDTH + 190, GameApplication.Y_OFFSET + 105), false, new Text("min", Text.DEFAULT_FONT_SMALL), true);
    public static final UIButton decreaseStepSize = new UIButton(new Point(GameApplication.X_OFFSET + Maze.WIDTH + 235, GameApplication.Y_OFFSET + 105), false, new Text("-", Text.DEFAULT_FONT_SMALL), true);
    public static final UIButton increaseStepSize = new UIButton(new Point(GameApplication.X_OFFSET + Maze.WIDTH + 260, GameApplication.Y_OFFSET + 105), false, new Text("+", Text.DEFAULT_FONT_SMALL), true);
    public static final UIButton maxStepSize = new UIButton(new Point(GameApplication.X_OFFSET + Maze.WIDTH + 285, GameApplication.Y_OFFSET + 105), false, new Text("max", Text.DEFAULT_FONT_SMALL), true);
    public static final UIButton step = new UIButton(new Point(GameApplication.X_OFFSET + Maze.WIDTH + 215, GameApplication.Y_OFFSET + 130), false, new Text("Step", Text.DEFAULT_FONT_LARGE, Screen.WHITE_COLOR), false);
    ...
    public AIAlgorithmsStepwiseLearningRenderer(TextRenderer textRenderer, Pacman pacman, SearchAlgorithm[] searchAlgorithms)
    {
	...
	expandedNodesColor = new UIButton(new Point(GameApplication.X_OFFSET + Maze.WIDTH + 245, GameApplication.Y_OFFSET + 85), false, defaultColorText, true);
	showSearchTree = new UIButton(new Point(GameApplication.X_OFFSET + Maze.WIDTH + 30, GameApplication.Y_OFFSET + 125), false, new Text("Show Search Tree", Text.DEFAULT_FONT_SMALL), true);
	toggleGrid = new UIButton(new Point(GameApplication.X_OFFSET + Maze.WIDTH + 30, GameApplication.Y_OFFSET + 145), false, new Text("Toggle Grid", Text.DEFAULT_FONT_SMALL), true);
	...
	textRenderer.renderText(screen, iterationsValueText, Maze.WIDTH + 30 + iterationsText.getWidth() + 5, 105, true);
	...
	if (stepwiseExecutionMode) {
		...
		textRenderer.renderText(screen, nodesExpandedText, Maze.WIDTH + xOffset, yOffset1 + 150 + yOffset, true);
		nodesInOpenListText.setTextMessage("Nodes in Search Frontier: " + SearchAlgorithm.unexpandedNodesDrawable.size());
		textRenderer.renderText(screen, nodesInOpenListText, Maze.WIDTH + xOffset, yOffset1 + 170 + yOffset, true);
		textRenderer.renderText(screen, currentActionStatusLabelText, Maze.WIDTH + xOffset, yOffset1 + 200 + yOffset, true);
		currentActionText.setTextMessage(stepwiseExecutionAlgorithm.getCurrentAction());
		textRenderer.renderText(screen, currentActionText, Maze.WIDTH + xOffset, yOffset1 + 220 + yOffset, true);
	    }
	} else {
		...
		textRenderer.renderText(screen, initialDepthText, Maze.WIDTH + 30, yOffset1RightPanel + yOffsetRightPanel + 25, true);
		initialDepthValueText.setTextMessage("[" + ((IterativeDeepeningAlgorithm) searchAlgorithms[selectedAlgorithmIndex]).getInitialDepth() + "]");
		textRenderer.renderText(screen, initialDepthValueText, Maze.WIDTH + 30 + initialDepthText.getWidth() + 10, yOffset1RightPanel + yOffsetRightPanel + 25, true);
		...
		textRenderer.renderText(screen, depthStepText, Maze.WIDTH + 30, yOffset1RightPanel + yOffsetRightPanel + 50, true);
		depthStepValueText.setTextMessage("[" + ((IterativeDeepeningAlgorithm) searchAlgorithms[selectedAlgorithmIndex]).getDepthStep() + "]");
		textRenderer.renderText(screen, depthStepValueText, Maze.WIDTH + 30 + depthStepText.getWidth() + 10, yOffset1RightPanel + yOffsetRightPanel + 50, true);
		...
		currentDepthText.setTextMessage("Current Depth: " + ((IterativeDeepeningAlgorithm) searchAlgorithms[selectedAlgorithmIndex]).getCurrentDepth());
		textRenderer.renderText(screen, currentDepthText, Maze.WIDTH + 30, yOffset1RightPanel + yOffsetRightPanel + 75, true);
	    } else if (selectedAlgorithmIndex == SearchAlgorithm.BS) {
		yOffsetRightPanel = -10;
		yOffset = 35;

		textRenderer.renderText(screen, beamWidthText, Maze.WIDTH + 30, yOffset1RightPanel + yOffsetRightPanel, true);
		beamWidthValueText.setTextMessage("[" + ((BeamSearchAlgorithm) searchAlgorithms[selectedAlgorithmIndex]).getBeamWidth() + "]");
		textRenderer.renderText(screen, beamWidthValueText, Maze.WIDTH + 30 + beamWidthText.getWidth() + 10, yOffset1RightPanel + yOffsetRightPanel, true);
	    ...
	    nodesVisitedText.setTextMessage("Nodes (tiles) visited: " + searchAlgorithms[selectedAlgorithmIndex].getNodesVisited());
	    textRenderer.renderText(screen, nodesVisitedText, Maze.WIDTH + xOffset, yOffset1 + 50 + yOffset, true);
	    nodesExpandedText.setTextMessage("Nodes (tiles) expanded: " + searchAlgorithms[selectedAlgorithmIndex].getNodesExpanded());
	    textRenderer.renderText(screen, nodesExpandedText, Maze.WIDTH + xOffset, yOffset1 + 75 + yOffset, true);
	    nodesInOpenListText.setTextMessage("Nodes in Search Frontier: " + searchAlgorithms[selectedAlgorithmIndex].getOpenListSize());
	    textRenderer.renderText(screen, nodesInOpenListText, Maze.WIDTH + xOffset, yOffset1 + 100 + yOffset, true);
	    solutionPathLengthInTiles.setTextMessage("Step: " + searchAlgorithms[selectedAlgorithmIndex].getPathInPoints().size() + " tiles");
	    textRenderer.renderText(screen, solutionPathLengthInTiles, Maze.WIDTH + xOffset, yOffset1 + 125 + yOffset, true);
