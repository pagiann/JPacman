...
public class Level
{
	...
	switch (value) {
	    case 0:
		if (Game.getActiveSubMode() == Game.SubMode.CUSTOM_SPACE_PATHFINDING || Game.getActiveSubMode() == Game.SubMode.CLASSIC_TSP) {
    ...
    private void setMovingSpeedMultipliers(double mult1, double mult2, double mult3, double mult4, double mult5, double mult6, double mult7, double mult8, double mult9, double mult10)
    {
