...
public class Edge
{
	...
	System.out.println("and the other vertex at [" + vertexB.x + "," + vertexB.y + "] with a weight of " + weight / Maze.TILE + " tile(s)");
    }
    ...
    {
	return "Edge [vertexA=" + vertexA + ", vertexB=" + vertexB + ", innerPoints=" + innerPoints + ", weight=" + weight + "]";
    }
