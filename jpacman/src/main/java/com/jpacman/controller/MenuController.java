...
public class MenuController implements Controller {
	...
	private void playModeMenu() {
		...
		for (int i = 0; i < MenuRenderer.NUMBER_OF_PLAY_MODE_BUTTONS; i++) {
			if (menuRenderer.getPlayModeMenuItems()[i].hasFocus()
					|| menuRenderer.getPlayModeMenuItems()[i].isMouseHovered()) {
	...
	private void educationalModeMenu() {
		...
		for (int i = 0; i < MenuRenderer.NUMBER_OF_EDUCATIONAL_MODE_BUTTONS; i++) {
			if (menuRenderer.getEducationalModeMenuItems()[i].hasFocus()
					|| menuRenderer.getEducationalModeMenuItems()[i].isMouseHovered()) {
