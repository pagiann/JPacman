...
public class LevelController {
	...
	private void initializeStaticData() {
		...
		GhostStatusController.setModePeriodsDurations(level.getScatterModePeriodsDurations(),
				level.getChaseModePeriodsDurations(), level.getFrightTimeDuration(), level.getNumberOfGhostsFlashes());
