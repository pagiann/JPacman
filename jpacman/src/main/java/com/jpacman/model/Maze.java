...
public class Maze
{
    ...
    public static Maze mazeCanvas = new Maze(MAZE_CANVAS, "/graphics/maze_canvas.png", WIDTH, HEIGHT, new Color(0, 0, 157));
    ...
    public static Maze maze5edu = new Maze(MAZE_4_EDU, "/graphics/maze_4_rnd.png", WIDTH, HEIGHT, new Color(0, 157, 157));
    public static Maze maze6edu = new Maze(MAZE_5_EDU, "/graphics/maze_5_rnd.png", WIDTH, HEIGHT, new Color(150, 0, 150));
    ...
    private final Color color; // the base color of the maze (used for fun stuff in some cases such as the search tree)
    ...
    // all (center) points of route's intersections' tiles (= all tiles with at least 1 possible direction change)
    private final ArrayList<Point> intersectionsTiles = new ArrayList<Point>(50);
    // all (center) points of route's cross roads' tiles (= all tiles with at least 2 possible direction changes)
    private final ArrayList<Point> crossroadsTiles = new ArrayList<Point>(50);
    // all (center) points of tiles (half size of default) that form the route inside ghosts house
	...
	for (int i = 0; i < routeTiles.size(); i++) {
	    ...
	    && routeTiles.contains(adjacentTiles[2]) || routeTiles.contains(adjacentTiles[0]) //
	    ...
	    && routeTiles.contains(adjacentTiles[3]) || routeTiles.contains(adjacentTiles[1]) //
