...
public class Node {
    ...
    public String toString() {
        return "Node [coordinates=" + coordinates + ", parent=" + parent + ", children=" + children + ", depth=" + depth
                + ", leaf=" + leaf + ", gCost=" + gCost + ", hCost=" + hCost + ", fCost=" + fCost + ", id=" + id
                + ", drawCoordinates=" + drawCoordinates + ", edgesDrawCoordinates=" + childNodesEdgesDrawCoordinates
                + ", dxRelocationDistance=" + dxRelocationDistance + "]";
    }
