...
public class Sprite {
	...
	// constructs a rectangular sprite with width = width * tileSize and height =
	// height * tileSize
	...
	public static Sprite rotateSprite(Sprite sprite, double angle) {
		return new Sprite(Sprite.rotate(sprite.pixels, sprite.width, sprite.height, angle), sprite.width,
				sprite.height);
	}
