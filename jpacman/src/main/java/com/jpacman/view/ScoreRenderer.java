...
public class ScoreRenderer implements Renderer {
    ...
    public ScoreRenderer(TextRenderer textRenderer) {
        ...
        scoreLabelPosition = new Point(scoreLabelPosition.x + 3 * Sprite.QUARTER_SPRITE_SIZE,
                scoreLabelPosition.y - 9 * Sprite.QUARTER_SPRITE_SIZE);
        scorePosition = new Point(this.scoreLabelPosition.x + Sprite.SPRITE_SIZE,
                this.scoreLabelPosition.y + 4 * Sprite.QUARTER_SPRITE_SIZE + yOffset);
        highScoreLabelPosition = new Point(highScoreLabelPosition.x - 15 * Sprite.HALF_SPRITE_SIZE,
                highScoreLabelPosition.y - 9 * Sprite.QUARTER_SPRITE_SIZE);
        highScorePosition = new Point(this.highScoreLabelPosition.x + Sprite.SPRITE_SIZE,
                this.highScoreLabelPosition.y + 4 * Sprite.QUARTER_SPRITE_SIZE + yOffset);
        score = "0";
        highScore = "0";
    }
    ...
    public void render(Screen screen) {
        ...
        textRenderer.renderText(screen, new Text(highScore, Screen.YELLOW_COLOR), highScorePosition.x,
                highScorePosition.y, true);
    }
