...
import com.jpacman.model.edumode.HeuristicAlgorithm;
...
public class EducationalModeRenderer implements Renderer {
    ...
    public static final UIButton backButton = new UIButton(
            new Point(0, GameApplication.WINDOW_HEIGHT - GameApplication.Y_OFFSET - 35), false, new Text("Back"), true);
    public static final UIButton cancelButton = new UIButton(
            new Point(105, GameApplication.WINDOW_HEIGHT - GameApplication.Y_OFFSET - 35), false, new Text("Cancel"),
            true);
    public static final UIButton randomizeButton = new UIButton(
            new Point(65, GameApplication.WINDOW_HEIGHT - GameApplication.Y_OFFSET - 70), false, new Text("Randomize"),
            true);
    public static final UIButton resetButton = new UIButton(
            new Point(105, GameApplication.WINDOW_HEIGHT - GameApplication.Y_OFFSET - 105), false, new Text("Reset"),
            false);
    public static final UIButton pauseButton = new UIButton(
            new Point(GameApplication.X_OFFSET + Maze.WIDTH + 110, GameApplication.Y_OFFSET + 15), false,
            new Text("Pause"), true);
    public static final UIButton resumeButton = new UIButton(
            new Point(GameApplication.X_OFFSET + Maze.WIDTH + 100, GameApplication.Y_OFFSET + 15), false,
            new Text("Resume"), true);
    ...
    public static final Text dontVisualizeIterationsText = new Text("Don't Visualize Iterations",
            Text.DEFAULT_FONT_SMALL);
    ...
    public UIButton showSearchTree = new UIButton(
    ...
    public UIButton toggleGrid = new UIButton(
            new Point(GameApplication.X_OFFSET + Maze.WIDTH + 30, GameApplication.Y_OFFSET + 80), false,
            new Text("Toggle Grid", Text.DEFAULT_FONT_SMALL), true);
    public Text expandedNodesColorText = new Text("Expanded Nodes Color:", Text.DEFAULT_FONT_SMALL, 0x9999FF);
    public UIButton expandedNodesColor = new UIButton(
            new Point(GameApplication.X_OFFSET + Maze.WIDTH + 245, GameApplication.Y_OFFSET + 105), false,
    ...
    public UIButton minNodeExpansionSpeed = new UIButton(
            new Point(GameApplication.X_OFFSET + Maze.WIDTH + 70, GameApplication.Y_OFFSET + 150), false,
            new Text("min", Text.DEFAULT_FONT_MEDIUM), true);
    public UIButton decreaseNodeExpansionSpeed = new UIButton(
            new Point(GameApplication.X_OFFSET + Maze.WIDTH + 145, GameApplication.Y_OFFSET + 150), false,
            new Text("-", Text.DEFAULT_FONT_MEDIUM), true);
    public UIButton increaseNodeExpansionSpeed = new UIButton(
            new Point(GameApplication.X_OFFSET + Maze.WIDTH + 185, GameApplication.Y_OFFSET + 150), false,
            new Text("+", Text.DEFAULT_FONT_MEDIUM), true);
    public UIButton maxNodeExpansionSpeed = new UIButton(
            new Point(GameApplication.X_OFFSET + Maze.WIDTH + 230, GameApplication.Y_OFFSET + 150), false,
    ...
    public UIButton minPacmanSpeed = new UIButton(
            new Point(GameApplication.X_OFFSET + Maze.WIDTH + 70, GameApplication.Y_OFFSET + 200), false,
            new Text("min", Text.DEFAULT_FONT_MEDIUM), true);
    public UIButton decreasePacmanSpeed = new UIButton(
            new Point(GameApplication.X_OFFSET + Maze.WIDTH + 145, GameApplication.Y_OFFSET + 200), false,
            new Text("-", Text.DEFAULT_FONT_MEDIUM), true);
    public UIButton increasePacmanSpeed = new UIButton(
            new Point(GameApplication.X_OFFSET + Maze.WIDTH + 185, GameApplication.Y_OFFSET + 200), false,
            new Text("+", Text.DEFAULT_FONT_MEDIUM), true);
    public UIButton maxPacmanSpeed = new UIButton(
            new Point(GameApplication.X_OFFSET + Maze.WIDTH + 230, GameApplication.Y_OFFSET + 200), false,
            new Text("max", Text.DEFAULT_FONT_MEDIUM), true);

    public UIButton visualizeIterations = new UIButton(
            new Point(GameApplication.X_OFFSET + Maze.WIDTH + 30, GameApplication.Y_OFFSET + yOffset1RightPanel + 30),
            false, visualizeIterationsText, true);
    ...
    public UIButton decreaseInitialDepth = new UIButton(
            new Point(GameApplication.X_OFFSET + Maze.WIDTH + 240, GameApplication.Y_OFFSET + yOffset2RightPanel + 5),
            false, new Text("-", Text.DEFAULT_FONT_SMALL), true);
    public UIButton increaseInitialDepth = new UIButton(
            new Point(GameApplication.X_OFFSET + Maze.WIDTH + 270, GameApplication.Y_OFFSET + yOffset2RightPanel + 5),
            false, new Text("+", Text.DEFAULT_FONT_SMALL), true);
    ...
    public UIButton decreaseDepthStep = new UIButton(
            new Point(GameApplication.X_OFFSET + Maze.WIDTH + 240, GameApplication.Y_OFFSET + yOffset2RightPanel + 25),
            false, new Text("-", Text.DEFAULT_FONT_SMALL), true);
    public UIButton increaseDepthStep = new UIButton(
            new Point(GameApplication.X_OFFSET + Maze.WIDTH + 270, GameApplication.Y_OFFSET + yOffset2RightPanel + 25),
            false, new Text("+", Text.DEFAULT_FONT_SMALL), true);
    ...
    public UIButton decreaseBeamWidth = new UIButton(
            new Point(GameApplication.X_OFFSET + Maze.WIDTH + 240, GameApplication.Y_OFFSET + yOffset2RightPanel),
            false, new Text("-", Text.DEFAULT_FONT_SMALL), true);
    public UIButton increaseBeamWidth = new UIButton(
            new Point(GameApplication.X_OFFSET + Maze.WIDTH + 270, GameApplication.Y_OFFSET + yOffset2RightPanel),
            false, new Text("+", Text.DEFAULT_FONT_SMALL), true);
    ...
    protected static final Text iterativeDeepeningText = new Text(IterativeDeepeningAlgorithm.NAME,
            Text.DEFAULT_FONT_SMALL);
    protected static final UIButton iterativeDeepening = new UIButton(new Point(xOffset, Y_OFFSET + 70), false,
            iterativeDeepeningText, true);
    ...
    protected static final UIButton bestFirst = new UIButton(new Point(xOffset, Y_OFFSET + 120), false, bestFirstText,
            true);
    protected static final Text manhattanHeuristicText1 = new Text(HeuristicAlgorithm.MANHATTAN_HEURISTIC_STRING,
            Text.DEFAULT_FONT_SMALL);
    protected static final UIButton manhattanHeuristic1 = new UIButton(new Point(xOffset + 20, Y_OFFSET + 140), false,
            manhattanHeuristicText1, true);
    protected static final Text chebyshevHeuristicText1 = new Text(HeuristicAlgorithm.CHEBYSHEV_HEURISTIC_STRING,
            Text.DEFAULT_FONT_SMALL);
    protected static final UIButton chebyshevHeuristic1 = new UIButton(new Point(xOffset + 20, Y_OFFSET + 160), false,
            chebyshevHeuristicText1, true);
    protected static final Text octileHeuristicText1 = new Text(HeuristicAlgorithm.OCTILE_HEURISTIC_STRING,
            Text.DEFAULT_FONT_SMALL);
    protected static final UIButton octileHeuristic1 = new UIButton(new Point(xOffset + 20, Y_OFFSET + 180), false,
            octileHeuristicText1, true);
    protected static final Text euclideanHeuristicText1 = new Text(HeuristicAlgorithm.EUCLIDEAN_HEURISTIC_STRING,
            Text.DEFAULT_FONT_SMALL);
    protected static final UIButton euclideanHeuristic1 = new UIButton(new Point(xOffset + 20, Y_OFFSET + 200), false,
            euclideanHeuristicText1, true);
    ...
    protected static final UIButton beamSearch = new UIButton(new Point(xOffset, Y_OFFSET + 140), false, beamSearchText,
            true);
    protected static final Text manhattanHeuristicText2 = new Text(HeuristicAlgorithm.MANHATTAN_HEURISTIC_STRING,
            Text.DEFAULT_FONT_SMALL);
    protected static final UIButton manhattanHeuristic2 = new UIButton(new Point(xOffset + 20, Y_OFFSET + 160), false,
            manhattanHeuristicText2, true);
    protected static final Text chebyshevHeuristicText2 = new Text(HeuristicAlgorithm.CHEBYSHEV_HEURISTIC_STRING,
            Text.DEFAULT_FONT_SMALL);
    protected static final UIButton chebyshevHeuristic2 = new UIButton(new Point(xOffset + 20, Y_OFFSET + 180), false,
            chebyshevHeuristicText2, true);
    protected static final Text octileHeuristicText2 = new Text(HeuristicAlgorithm.OCTILE_HEURISTIC_STRING,
            Text.DEFAULT_FONT_SMALL);
    protected static final UIButton octileHeuristic2 = new UIButton(new Point(xOffset + 20, Y_OFFSET + 200), false,
            octileHeuristicText2, true);
    protected static final Text euclideanHeuristicText2 = new Text(HeuristicAlgorithm.EUCLIDEAN_HEURISTIC_STRING,
            Text.DEFAULT_FONT_SMALL);
    protected static final UIButton euclideanHeuristic2 = new UIButton(new Point(xOffset + 20, Y_OFFSET + 220), false,
            euclideanHeuristicText2, true);
    ...
    protected static final Text manhattanHeuristicText3 = new Text(HeuristicAlgorithm.MANHATTAN_HEURISTIC_STRING,
            Text.DEFAULT_FONT_SMALL);
    protected static final UIButton manhattanHeuristic3 = new UIButton(new Point(xOffset + 20, Y_OFFSET + 180), false,
            manhattanHeuristicText3, true);
    protected static final Text chebyshevHeuristicText3 = new Text(HeuristicAlgorithm.CHEBYSHEV_HEURISTIC_STRING,
            Text.DEFAULT_FONT_SMALL);
    protected static final UIButton chebyshevHeuristic3 = new UIButton(new Point(xOffset + 20, Y_OFFSET + 200), false,
            chebyshevHeuristicText3, true);
    protected static final Text octileHeuristicText3 = new Text(HeuristicAlgorithm.OCTILE_HEURISTIC_STRING,
            Text.DEFAULT_FONT_SMALL);
    protected static final UIButton octileHeuristic3 = new UIButton(new Point(xOffset + 20, Y_OFFSET + 220), false,
            octileHeuristicText3, true);
    protected static final Text euclideanHeuristicText3 = new Text(HeuristicAlgorithm.EUCLIDEAN_HEURISTIC_STRING,
            Text.DEFAULT_FONT_SMALL);
    protected static final UIButton euclideanHeuristic3 = new UIButton(new Point(xOffset + 20, Y_OFFSET + 240), false,
            euclideanHeuristicText3, true);

    protected static final Text selectMazeText = new Text("Select Maze", Text.DEFAULT_FONT_MEDIUM, 0x9999FF);

    protected static final Text algorithmInfoText = new Text("------ ALGORITHM INFO ------", Text.DEFAULT_FONT_SMALL,
            0x9999FF);
    ...
    protected static final Text pacmanInfoText = new Text("------- PACMAN INFO --------", Text.DEFAULT_FONT_SMALL,
            0x9999FF);
    ...
    protected void renderAlgorithmButtons(Screen screen) {
        for (UIButton algorithmMenuButton : algorithms) {
            if (algorithmMenuButton.isVisible()) {
                ...
                textRenderer.renderText(screen, algorithmMenuButton.getText(), algorithmMenuButton.getBounds().x,
                        algorithmMenuButton.getBounds().y, false);
