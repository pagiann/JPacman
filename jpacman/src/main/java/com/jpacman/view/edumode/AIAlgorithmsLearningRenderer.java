...
public class AIAlgorithmsLearningRenderer extends EducationalModeRenderer {
    ...
    public static final Text modeSelectionText = new Text("Select a mode", Text.DEFAULT_FONT_LARGE,
            Screen.YELLOW_COLOR);
    ...
    public static final UIButton stepwiseExecutionButton = new UIButton(new Point(Maze.WIDTH, Maze.HEIGHT / 2 + 15),
            true, stepwiseExecutionText, true);
    public static final UIButton interactiveExecutionButton = new UIButton(
            new Point(Maze.WIDTH, (Maze.HEIGHT / 2) + 65), true, interactiveExecutionText, true);
