...
public final class PathFinder
{
    ...
    // returns a new pseudo-random (but valid) direction, different from the opposite of the current direction
	...
	// get an array, randomly filled with the rest 3 directions besides the opposite of the current one
